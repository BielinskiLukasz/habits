...
- [ ] 02-04-PLAN.md — seed/habits.json (8 habits covering D-32 matrix) + js/io/seed.js (idempotent merge-by-id + first-run persist()) + integration tests (split per W2: seed-only)
