...
17. ⏳ Bump APP_VERSION to `'0.1.1'`, redeploy, reload twice → toast "New version ready — Reload" appears; old user (first install) does NOT see toast on initial install.
