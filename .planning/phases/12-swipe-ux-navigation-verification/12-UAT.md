...
result: issue
reported: "pass (its quicker now!), but we broke something... all statuses are critical in analytics view (analytic and waves)"
severity: major
...
result: skipped
reason: "not sure what should test"
...
- test: 1
  idea: "pass, but it should display next state like for swipe left"
