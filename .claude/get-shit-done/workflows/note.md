...
- **Global scope**: `C:/Users/lukasz.bielinski/projects/habits/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/lukasz.bielinski/projects/habits/.claude/notes/`)
...
2. Glob `C:/Users/lukasz.bielinski/projects/habits/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/lukasz.bielinski/projects/habits/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/lukasz.bielinski/projects/habits/.claude/notes/` — works in any directory
