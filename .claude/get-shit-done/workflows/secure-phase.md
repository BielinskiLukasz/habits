...
```
Agent(
  prompt="Read C:/Users/lukasz.bielinski/projects/habits/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/lukasz.bielinski/projects/habits/.claude/get-shit-done/templates/SECURITY.md`
