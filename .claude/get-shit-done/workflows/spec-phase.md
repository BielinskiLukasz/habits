...
```bash
INIT=$(node "C:/Users/lukasz.bielinski/projects/habits/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/lukasz.bielinski/projects/habits/.claude/get-shit-done/templates/spec.md.
